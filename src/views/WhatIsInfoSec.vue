      ...
      principles: [
        {
          ...
          icon: "fas fa-lock",
          description: "Only authorized users should access sensitive data.",
          bgLight: "#d9f0ff",
          bgDark: "#1e88e5",
        },
        {
          ...
          description:
            "Ensure information is accurate and hasn't been altered.",
          bgLight: "#eafcd4",
          bgDark: "#28c76f",
        },
        {
          name: "Availability",
          icon: "fas fa-clock",
          description: "Data should be accessible when needed.",
          bgLight: "#ffeedf",
          bgDark: "#ff9800",
        },
      ],
